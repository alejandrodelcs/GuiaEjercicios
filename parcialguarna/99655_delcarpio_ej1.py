...
def vocales_cadena(cadena):
    ...
    *
    ...
    cadena_vocales = ''
    cadena_caracteres = ["","*","+","-"]
    if cadena.isalnum()==True and cadena not in cadena_caracteres:
        for letra in cadena :
            if letra in "aeiouáéíóúÁÉÍÓÚAEIOU" and letra.upper() not in cadena_vocales and letra.lower() not in cadena_vocales:
